...
# Define the function to fetch market data from CoinGecko API
...
with DAG(
    ...
    description="ETL DAG for cryptocurrency data from CoinGecko",
    schedule_interval="0 12 * * *",  # Daily at Noon
    start_date=datetime(2025, 1, 4),
    catchup=False,
) as dag:

    # Task to fetch and save CoinGecko data
