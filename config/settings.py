...
S3_STAGE_NAME_COIN_GECKO = "CRYPTO_DATA.PUBLIC.coingecko_stage"
SNOWFLAKE_TABLE = "CRYPTO_DATA.PUBLIC.crypto_coins_list"
SNOWFLAKE_TABLE_COINGECKO = "CRYPTO_DATA.PUBLIC.coingeko_coins_list"
S3_FILE_PATH1 = "coingecko.csv" 
S3_FILE_PATH2 = "coingecko_coins_list.csv" 